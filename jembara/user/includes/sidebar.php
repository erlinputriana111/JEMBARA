...
$menus = [
    ...
    [
        "page" => "tracking",
        "href" => "/user/tracking.php",
        "icon" => "users",
        "label" => "Tracking Surat",
    ],
];
...
<aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-red-950 text-white flex flex-col z-40 transition-transform duration-300">
  ...
  <div class="px-4 py-4 border-t border-red-900 flex items-center gap-3">
    ...
    <div class="flex-1 min-w-0">
      <p class="text-sm font-semibold text-white truncate"><?= htmlspecialchars(
          $user["nama"],
      ) ?></p>
      <p class="text-xs text-red-300 capitalize"><?= htmlspecialchars(
          "Pengguna",
      ) ?></p>
    </div>
